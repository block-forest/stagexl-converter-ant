...
package org.springextensions.actionscript.context.impl {
	 ...
	 * @author Roland Zwaga
	 */
	public class SpringApplicationContext extends EventDispatcher implements IApplicationContext, IDisposable, /*IAutowireProcessorAware,*/ IEventBusAware /*, IEventBusUserRegistryAware , ILoaderInfoAware*/ {
		...
		private static const LOGGER:ILogger = getClassLogger(SpringApplicationContext);
		 ...
		 */
		public function SpringApplicationContext(rootViews:Vector.<DisplayObject>=null, objFactory:IObjectFactory=null) {
			super();
		...
		/* Not Stageprocessing in Dart for now */
		...
		*/
		...
		public function wire(instance:*, objectDefinition:IObjectDefinition=null, constructorArguments:Array=null, objectName:String=null):* {
		...
		private function addFactoryListeners(objectFactory:IObjectFactory):void {
